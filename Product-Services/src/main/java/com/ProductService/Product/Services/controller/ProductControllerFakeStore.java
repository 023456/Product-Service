...
import com.ProductService.Product.Services.service.ProductServiceFakeStore;
...
public class ProductControllerFakeStore {
    ...
    private ProductServiceFakeStore productService;

    public ProductControllerFakeStore(@Qualifier("fakeStoreProductService") ProductServiceFakeStore productService) {
