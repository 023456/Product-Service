...
public class ProductController {
  ...
  public Product createProduct(@RequestBody GenericProductDto requestDto) throws NotFoundException {
    ...
    @PutMapping("{id}")
    public Product updateProductById(@PathVariable("id") UUID id ,@RequestBody GenericProductDto genericProductDto) throws NotFoundException {
        return productService.updateProductById(id,genericProductDto);
    }

    @DeleteMapping("{id}")
    public DeleteProductResponse deleteProduct(@PathVariable("id") UUID id) throws NotFoundException {
