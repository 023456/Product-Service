...
(
    order_idssss   BINARY(16) NOT NULL,
    product_idssss BINARY(16) NOT NULL
);
...
ALTER TABLE products_orders
    ADD CONSTRAINT fk_proord_on_orders FOREIGN KEY (order_idssss) REFERENCES orders (id);

ALTER TABLE products_orders
    ADD CONSTRAINT fk_proord_on_product FOREIGN KEY (product_idssss) REFERENCES product (id);